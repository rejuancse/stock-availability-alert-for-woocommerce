...
Tags: stock alert, email, notification, stock availability
...
Go to Dashboard > Plugins > Add New, then upload enhanced-stock-availability-alert.zip file and click Install Now.
